// Usage: root -l -b -q 'prod_ntp_v7_intwin.C(20260831,11,100)'   // (dateTag, run, intWindowNs)
//
#include <vector>
#include <string>
#include <iostream>
...
void prod_ntp_v7_intwin(int dateTag, int run, int intWindowNs = 100) {
    ...
    // File found directly from date+run (not the ambiguous find_filepath(run)
    // glob, which matches by run number alone and can hit the wrong date).
    {
