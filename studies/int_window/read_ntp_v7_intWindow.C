// Usage: root -l -b -q 'read_ntp_v7_intWindow.C(20260831,11,11,100)'   // (dateTag, startRun, endRun, intWindowNs)
#include <fstream>
#include <vector>
#include <string>
#include <iostream>
...
void ReadOneRun(int dateTag, int run, int intWindowNs) {
...
void read_ntp_v7_intWindow(int dateTag, int startRun, int endRun, int intWindowNs = 100) {
    for (int r = startRun; r <= endRun; ++r) ReadOneRun(dateTag, r, intWindowNs);
    std::cout << "[INFO] read done: " << dateTag << " runs " << startRun << "-" << endRun
